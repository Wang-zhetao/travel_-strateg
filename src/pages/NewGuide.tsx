      ...
      <div className="max-w-[1440px] w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="bg-gradient-to-r from-gray-800 to-black p-6 text-white">
            ...
            <p className="text-gray-300 mb-6">分享你的旅行经验，帮助他人探索世界</p>
            ...
            <div className="flex items-center justify-between mb-2">
              {steps.map((step, index) => (
                <button
                  ...
                  className={`text-sm font-medium ${activeStep >= index ? 'text-white' : 'text-gray-400'}`}
                >
                  {step.name}
                </button>
              ))}
            ...
            <div className="w-full bg-gray-600 bg-opacity-30 h-2 rounded-full">
              <motion.div 
                initial={{ width: '0%' }}
